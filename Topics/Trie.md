...
* A vairant for the search routine that supports wildcard character: [211-Add and Search Word - Data structure design](../200-299/211-Add-and-Search-Word---Data-structure-design.cpp).

* When the alphabet is simply {0, 1}, it is called a **Bitwise Trie**: [421-Maximum XOR of Two Numbers in an Array](../400-499/421-Maximum-XOR-of-Two-Numbers-in-an-Array.md).

* **Suffix Tree**: [1032-Stream of Characters](../1000-1099/1032-Stream-of-Characters.md).

* Trie used as a map to keep track of the prefix sums: [677-Map Sum Pairs](../600-699/677-Map-Sum-Pairs.md).
